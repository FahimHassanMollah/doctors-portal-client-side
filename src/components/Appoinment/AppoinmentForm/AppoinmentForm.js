...
const AppoinmentForm = ({ closeModal, modalIsOpen, disiceaseName,bookingDate }) => {
    ...
    return (
        <div>
            ...
            >
                ...
                <h2 className="text-center text-brand">{disiceaseName}</h2>
                 <p className="text-center text-brand">{bookingDate}</p>
